...
public class LambdaExpressionsTest {
    ...
    public void lambdaExpression_predicate() {
        ...
        System.out.println();
        numbers.stream()
                .filter((number) -> (number % 2 != 0)) //Predicate. Predicate is something which is true or false
                .forEach(LambdaExpressionsTest::print); //Lambda Expression to Method Reference
    }
    ...
    //.map(s -> String.toLowerCase(s)) using lambda Expression
}
